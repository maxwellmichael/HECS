...
const SingleBrand = ({
  ...
  return (
    <div
      ...
      } mx-w-full bg-[rgba(255, 255, 255, 0.2))] group relative mx-6 block h-20 w-full rounded rounded-b-none opacity-100 backdrop-blur-lg transition-all duration-300 hover:bg-primary hover:opacity-80`}
    >
      <h3 className={`${
        selected === index ? "text-white opacity-100" : null
